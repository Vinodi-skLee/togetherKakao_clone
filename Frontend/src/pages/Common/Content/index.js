...
export default function Content() {
    // const list = document.querySelector('.list_slide');
    // const items = document.querySelectorAll('.slide_pannel');
            ...
            <div id="mainContent">
                <div className="topslide_container">
                    <div className="inner_slide">
                        <ul className="list_slide" data-tiara-layer="cover"
                    ...
                    <img className="img_slide" src={img2} alt="img2"/>
                            ...
                            <li className="slide_pannel">
                                <a aria-hidden="false" className="link_slide" href="/">
                                    ...
                                    <span className="area_thumb">
                    <img className="img_slide" src="../../asset/img/1.jpeg" alt="img1"/>
                  </span>
                                </a>
                            </li>
                            <li className="slide_pannel">
                ...
                <img className="img_slide" src={img1} alt="img1" />
                    ...
                    <div className="story_container">
                        <a className="story_banner" href="/">
                            <img class="story_banner_img"
                                 src="https://mud-kage.kakaocdn.net/dn/cNhupn/btrGE2vmZgH/UjfKDHXe7gv99TuYeFFMPk/img.png"
                                 alt=""/>
                        </a>
                    </div>
